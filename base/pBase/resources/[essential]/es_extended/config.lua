...
Config.DisableRoulade 			 = true -- Désactiver la roulade
Config.DisableCoupdecrosse 		 = true -- Désactiver le coup de crosse
Config.DisableNorthRadarBlip 	 = true -- Désactiver le blip du nord sur le radar

Config.ActivateSwitchPlacesInCar = true -- Activer le changement de place dans tous le véhicule
Config.ActivateHideTrunk		 = true -- Activer la possibilitée de se cacher dans le coffre d'un véhicule
Config.ActivateSlashtires   	 = true -- Activer la possibilitée de pouvoir crever des pneus avec une arme blanche (couteau)
Config.ActivateTrain   	   		 = true -- Activer la possibilitée d'avoir les trains
Config.ActivateCayo   	   		 = true -- Activer cayo périco
Config.ActivateTazerEffect   	 = true -- Activer l'effet tazer
Config.ActivateRagdoll 			 = {Activate = true, Key = "COMMA"} -- COMMA = ; (https://docs.fivem.net/docs/game-references/input-mapper-parameter-ids/keyboard/)
Config.ActivateAllonger 		 = {Activate = true, Key = "C"} -- Activer s'allonger sur le sol
Config.ActivateClignotant 		 = {Activate = true, RightKey = "NUMPAD9", LeftKey = "NUMPAD7"}
Config.ActivateToggleMoteur 	 = {Activate = true, Key = "NUMPAD8"} -- Activer Allumer / Éteindre moteur
Config.ActivateCrossArms 	   	 = {Activate = true, Key = "G"} -- Activer Croiser les bras
Config.ActivateCrouch 	   		 = {Activate = true, Key = "LCONTROL"} -- Activer S'accroupir
Config.ActivateHandsup 	   		 = {Activate = true, Key = "X"} -- Activer Level les bras
Config.ActivatePointFinger		 = {Activate = true, Key = "B"} -- Activer pointer du doigt
Config.ActivateNoclip		     = {Activate = true, Key = "F4"}  -- Activer le noclip + noclip vehicle
Config.ActivateZoomMap 		     = {Activate = true, KeyUp = "PAGEUP", KeyDown = "PAGEDOWN"} -- Activer la possibilitée de Dézoom / Zoom sur la minimap
Config.ActivateTimeBar 			 = {Activate = true, CommandStart = "timebar", CommandStop = "stoptimebar"} -- Activer la timebar
Config.ActivateCarry 			 = {Activate = true, CommandENG = true, CommandFR = true} -- Activer /porter & /carry
Config.ActivateTakeOtage 		 = { -- Activer /otage
	Activate = true, 
	Command = "otage", 
	AllowedWeapons = {
		`WEAPON_PISTOL`,
...
Config.SetPNJAmount = {
	Activate = true,
	SetVehicleDensityMultiplierThisFrame = 0.03, -- 0.0 - 1.0 / ex (conseil) : 0.03
	SetPedDensityMultiplierThisFrame = 0.5, -- 0.0 - 1.0 / ex (conseil) : 0.5
	SetRandomVehicleDensityMultiplierThisFrame = 0.04, -- 0.0 - 1.0 / ex (conseil) : 0.04
	SetParkedVehicleDensityMultiplierThisFrame = 0.25, -- 0.0 - 1.0 / ex (conseil) : 0.25
	SetScenarioPedDensityMultiplierThisFrame = 0.15, -- 0.0 - 1.0 / ex (conseil) : 0.15
}
