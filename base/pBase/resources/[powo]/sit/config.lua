...
Config.Lang = {
    -- Notifications
    Notification = {
        OccupiedSit = "Ce siège est déjà occupé !",
        ...
        NoBedFound = "Rien sur lequel se coucher n'a été trouvé !",
        TooTilted = "Ce siège est trop incliné !",
        CannotReachSeat = "Vous ne pouvez pas atteindre ce siège !",
        CannotSitInSeat = "Vous ne pouvez pas vous asseoir à ce siège !",
        CannotReachBed = "Vous ne pouvez pas atteindre ce lit/banc !",
        AlreadyAttemptingToSit = "Vous essayez déjà de vous asseoir !",
        AlreadyAttemptingToLay = "Vous essayez déjà de vous coucher !"
    },

    -- Chat Suggestions
    ChatSuggestions = {
        Sit = "Asseyez-vous sur le siège le plus proche",
        Lay = "Allongez-vous sur le lit/banc le plus proche"
    },
    ...
    KeyBindingDesc = {
        Keyboard = {
            SitDown = "Assis - Asseyez-vous sur le siège",
            LayDown = "Allongez-vous = Assis - Allongez-vous sur le lit/banc",
            GetUp = "Assis - Levez-vous du siège/lit"
        },
        PadAnalog = {
            SitDown = "Assis - Asseyez-vous sur le siège - Contrôleur",
            LayDown = "Assis - Allongé sur le lit/banc - Contrôleur",
            GetUp = "S'asseoir - Se lever du siège/du lit - Contrôleur"
        }
    }
}
