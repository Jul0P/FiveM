...
Config.Strings = {
	...
	EToRefuel = "Appuyez sur ~g~E ~s~pour faire le plein du véhicule",
	JerryCanEmpty = "Le jerrican est vide",
	FullTank = "Réservoir est plein",
	PurchaseJerryCan = "Appuyez sur ~g~E ~s~pour acheter un jerrycan pour ~g~$" .. Config.JerryCanCost,
	CancelFuelingPump = "Appuyez sur ~g~E ~s~pour annuler le ravitaillement",
	CancelFuelingJerryCan = "Appuyez sur ~g~E ~s~pour annuler le ravitaillement",
	NotEnoughCash = "Pas assez d'argent",
	RefillJerryCan = "Appuyez sur ~g~E ~s~ pour remplir le jerrican pour ",
...
if not Config.UseESX then
	Config.Strings.PurchaseJerryCan = "Appuyez sur ~g~E ~s~ pour saisir un jerrycan"
	Config.Strings.RefillJerryCan = "Appuyez sur ~g~E ~s~ pour remplir le jerrican"
end
