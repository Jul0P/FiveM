Locales["fr"] = {
	...
	["threw_pickup_prompt"] = "Appuyez sur ~b~E~s~ pour ramasser",

	-- Key mapping
	["keymap_showinventory"] = "Afficher l'inventaire",

	-- Salary related
	["received_salary"] = "Vous avez reçu votre salaire: ~g~$%s",
	["received_help"] = "Vous avez reçu une aide de l'état: ~g~$%s",
